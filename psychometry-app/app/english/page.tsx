...
export default function EnglishPage() {
  ...
  const subcategories = [
    ...
    { id: 'restatements', name: 'Restatements' },
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8">
        <div className="max-w-[280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-right">מבחן באנגלית</h1>
  ...
  return <TestInterface section="english" subcategory={selectedSubcategory} />;
} 